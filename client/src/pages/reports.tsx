    ...
    <>
      <main className="w-full space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <MetricsCard
            title="معدل التحويل"
            value={formatPercentage(parseFloat(calculateConversionRate()))}
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-semibold">{formatPercentage(parseFloat(calculateConversionRate()))}</span>
                    </div>
                    <div className="flex justify-between items-center">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-semibold">
                        {filteredDeals.length > 0 
                          ? formatPercentage((calculateTotalCommission() / 
                              filteredDeals.reduce((sum, deal) => 
                                sum + (deal.dealValue ? parseFloat(deal.dealValue) : 0), 0
                              )) * 100)
                          : formatPercentage(0)}
