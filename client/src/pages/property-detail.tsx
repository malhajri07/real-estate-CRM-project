        ...
        <div className="flex items-center justify-between p-4 max-w-[1600px] mx-auto">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="relative group">
              ...
              {/* Share Dropdown Menu */}
              <div className="absolute top-full left-0 mt-2 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10 min-w-[140px]">
