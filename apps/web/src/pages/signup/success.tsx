  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-slate-100 px-4 py-16" dir="rtl">
      <div className="max-w-3xl mx-auto">
        <div className="space-y-6 rounded-2xl border border-white/80 bg-white/90 p-10 text-end shadow-[0_35px_120px_rgba(16,185,129,0.18)] backdrop-blur-xl" dir="rtl">
