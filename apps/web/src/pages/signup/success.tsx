  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-slate-100 px-4 py-16" dir="rtl">
      <div className="max-w-3xl mx-auto">
        <div className="space-y-6 rounded-[32px] border border-white/80 bg-white/90 p-10 text-end shadow-[0_35px_120px_rgba(16,185,129,0.18)] backdrop-blur-xl" dir="rtl">
          ...
          <div className="rounded-3xl border border-emerald-100 bg-emerald-50/80 p-6" dir="rtl">
            <h2 className="mb-4 text-lg font-semibold text-emerald-800 text-end">الخطوات التالية</h2>
            <ul className="space-y-3 text-emerald-700 list-none pe-0" dir="rtl">
