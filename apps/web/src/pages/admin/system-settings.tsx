                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
                    <div className="flex items-center gap-6">
                        ...
                        <div className="text-center md:text-end">
                            <h1 className="text-3xl font-bold text-slate-900 tracking-tight">إعدادات النظام</h1>
            ...
            <Tabs value={activeTab} onValueChange={handleTabChange} className="space-y-8">
                ...
                <TabsContent value="general" className="space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <Card className="glass border-0 rounded-3xl p-8 shadow-none space-y-8">
                            <div>
                                <h3 className="text-xl font-bold text-slate-900 tracking-tight">معلومات الموقع</h3>
                                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">المعلومات الأساسية للمنصة</p>
                            </div>
                            <div className="space-y-6">
                                <div className="space-y-2">
                                    <Label className="text-xs font-bold text-slate-400 uppercase tracking-widest px-1">اسم المنصة</Label>
                                    <Input defaultValue="عقاراتي بلس" className="h-12 rounded-xl bg-white border-slate-100 font-bold" />
                                </div>
                                <div className="space-y-2">
                                    <Label className="text-xs font-bold text-slate-400 uppercase tracking-widest px-1">وصف المنصة (SEO)</Label>
                                ...
                                <div className="space-y-2">
                                    <Label className="text-xs font-bold text-slate-400 uppercase tracking-widest px-1">البريد الإلكتروني للإشعارات</Label>
                        ...
                        <Card className="glass border-0 rounded-3xl p-8 shadow-none space-y-8">
                            <div>
                                <h3 className="text-xl font-bold text-slate-900 tracking-tight">التوقيت واللغة</h3>
                                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">تهيئة التخصيص الإقليمي</p>
                            </div>
                            <div className="space-y-6">
                                <div className="space-y-2">
                                    <Label className="text-xs font-bold text-slate-400 uppercase tracking-widest px-1">اللغة الافتراضية</Label>
                                ...
                                <div className="space-y-2">
                                    <Label className="text-xs font-bold text-slate-400 uppercase tracking-widest px-1">المنطقة الزمنية</Label>
                                ...
                                <div className="flex items-center justify-between p-6 bg-blue-50/50 rounded-3xl border border-blue-100/50 group transition-all hover:bg-white hover:shadow-xl hover:shadow-blue-500/5">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="text-sm font-bold text-slate-900">تفعيل تعدد اللغات</p>
                                            <p className="text-xs font-bold text-slate-400 uppercase tracking-tighter">السماح للمستخدمين بتغيير اللغة</p>
                                        </div>
                                    </div>
                ...
                <TabsContent value="branding" className="space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <Card className="glass border-0 rounded-3xl p-8 shadow-none space-y-8">
                            <div>
                                <h3 className="text-xl font-bold text-slate-900 tracking-tight">الشعارات</h3>
                            ...
                            <div className="space-y-6">
                                <div className="p-6 bg-slate-50/50 rounded-3xl border border-slate-100 flex flex-col items-center gap-4 group cursor-pointer hover:bg-white transition-all">
                                    <div className="h-20 w-48 bg-white rounded-2xl shadow-sm flex items-center justify-center border-2 border-dashed border-border group-hover:border-blue-300 transition-all overflow-hidden relative">
                                    ...
                                    <div className="text-center">
                                        <p className="text-sm font-bold text-slate-900">الشعار الرئيسي</p>
                                        <p className="text-xs font-bold text-slate-400">يفضل خلفية شفافة PNG</p>
                                    </div>
                                </div>
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="p-4 bg-slate-50/50 rounded-2xl border border-slate-100 flex flex-col items-center gap-2">
                                        ...
                                        <span className="text-xs font-bold text-slate-900">أيقونة الموقع</span>
                                    </div>
                                    <div className="p-4 bg-slate-50/50 rounded-2xl border border-slate-100 flex flex-col items-center gap-2">
                                        <div className="h-12 w-12 bg-white rounded-xl shadow-sm flex items-center justify-center border border-slate-100"><ImageIcon className="h-5 w-5 text-slate-300" /></div>
                                        <span className="text-xs font-bold text-slate-900">شعار الجوال</span>
                                    </div>
                                </div>
                            </div>
                        </Card>
                        ...
                        <Card className="glass border-0 rounded-3xl p-8 shadow-none space-y-8">
                            <div>
                                <h3 className="text-xl font-bold text-slate-900 tracking-tight">الألوان والسمات</h3>
                                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">تخصيص ألوان الواجهة</p>
                            </div>
                            <div className="space-y-6">
                                <div className="space-y-4">
                                    <Label className="text-xs font-bold text-slate-400 uppercase tracking-widest px-1">اللون الرئيسي (Primary Color)</Label>
                                ...
                                <div className="space-y-2">
                                    <Label className="text-xs font-bold text-slate-400 uppercase tracking-widest px-1">نمط الحواف (Radius)</Label>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <Card className="glass border-0 rounded-3xl p-8 shadow-none space-y-8">
                            <div className="flex items-center justify-between">
                                <div>
                                    <h3 className="text-xl font-bold text-slate-900 tracking-tight">خدمات الرسائل</h3>
                                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">SMS & WhatsApp APIs</p>
                                </div>
                                <Badge className="bg-emerald-50 text-emerald-700 border-0 px-3 py-1 rounded-lg font-bold text-xs">متصل</Badge>
                            </div>
                            <div className="space-y-6">
                                <div className="space-y-2">
                                    <Label className="text-xs font-bold text-slate-400 uppercase tracking-widest px-1">API Key (Twilio/Unifonic)</Label>
                                    <Input value="••••••••••••••••••••••••" className="h-12 rounded-xl bg-slate-50 border-slate-100 font-mono" dir="ltr" disabled />
                                </div>
                                <Button variant="outline" className="w-full h-12 rounded-xl border-border font-bold text-slate-600 hover:bg-slate-50">اختبار الاتصال</Button>
                            </div>
                        </Card>
                        ...
                        <Card className="glass border-0 rounded-3xl p-8 shadow-none space-y-8">
                            <div className="flex items-center justify-between">
                                <div>
                                    <h3 className="text-xl font-bold text-slate-900 tracking-tight">خرائط جوجل</h3>
                            ...
                            <div className="space-y-6">
                                <div className="space-y-2">
                                    <Label className="text-xs font-bold text-slate-400 uppercase tracking-widest px-1">Maps API Key</Label>
                                    <Input placeholder="أدخل مفتاح التحقق..." className="h-12 rounded-xl bg-white border-slate-100 font-mono" dir="ltr" />
                                </div>
                                <p className="text-xs font-medium text-slate-500 bg-slate-50 p-3 rounded-xl border border-slate-100">يستخدم هذا المفتاح لعرض الخرائط في صفحات العقارات والبحث الجغرافي.</p>
                            </div>
                        </Card>
                    </div>
                </TabsContent>
                ...
                <TabsContent value="advanced" className="space-y-8">
                    <Card className="glass border-0 rounded-3xl p-8 shadow-none space-y-8">
                        <div>
                            <h3 className="text-xl font-bold text-slate-900 tracking-tight">صيانة النظام</h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="p-6 bg-slate-50/50 rounded-3xl border border-slate-100 space-y-4 group hover:bg-white hover:shadow-xl transition-all">
                                ...
                                <div>
                                    <h4 className="text-sm font-bold text-slate-900">نسخة احتياطية</h4>
                                    <p className="text-xs font-medium text-slate-500 mt-1">تصدير كامل لقاعدة البيانات الحالية</p>
                                </div>
                            ...
                            <div className="p-6 bg-rose-50/30 rounded-3xl border border-rose-100 space-y-4 group hover:bg-white hover:shadow-xl transition-all">
                                ...
                                <div>
                                    <h4 className="text-sm font-bold text-slate-900 text-rose-700">وضع التصحيح (Debug)</h4>
