            ...
            <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                {isLoading ? (
                    Array.from({ length: 4 }).map((_, i) => (
                        <Card key={i} className="bg-white/50 border border-slate-100 rounded-2xl p-6">
                    ...
                    <Card key={template.id} className="bg-white/50 border border-slate-100 rounded-2xl p-6 hover:bg-white hover:shadow-2xl transition-all duration-300 group relative overflow-visible">
                        <div className="flex items-start justify-between mb-4">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h4 className="text-lg font-bold text-slate-900 tracking-tight">{template.name}</h4>
                                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">{template.category}</p>
                                </div>
                            </div>
                            <Badge className={cn(
                        ...
                        <div className="flex items-center gap-2 mb-6">
                            {template.channels.map((channel, i) => (
                                <Badge key={i} variant="outline" className="text-xs font-bold border-slate-100 bg-slate-50/50 text-slate-600 px-2 py-0.5 rounded-lg flex items-center gap-1">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
                    <div className="flex items-center gap-6">
                        ...
                        <div className="text-center md:text-end">
                            <h1 className="text-3xl font-bold text-slate-900 tracking-tight">مركز الإشعارات والقوالب</h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <Card key={i} className="glass border-0 rounded-3xl p-8 shadow-none text-center flex flex-col items-center group hover:bg-white hover:shadow-2xl transition-all duration-300">
                                ...
                                <h4 className="text-lg font-bold text-slate-900 mb-2">{channel.name}</h4>
                                <Badge className={cn(
