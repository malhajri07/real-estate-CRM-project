...
const englishTranslations: Record<string, string> = {
  ...
  'dashboard.welcome_subtitle': 'Overview of your performance today',
  'nav.dashboard': 'Dashboard',
  'nav.pool': 'Customer Pool',
  'nav.forum': 'Community Forum',
  'forum.title': 'Community Forum',
  'forum.create_post': 'New Post',
  'forum.start_discussion': 'Start Discussion',
  'forum.placeholder': "What's on your mind? Share news, announcements, or ask a question...",
  'forum.cancel': 'Cancel',
  'forum.post': 'Post',
  'forum.posting': 'Posting...',
  'forum.channels': 'Channels',
  'forum.create_channel': 'Create Channel',
  'forum.channel_name_ar': 'Channel name (Arabic)',
  'forum.channel_name_en': 'Channel name (English)',
  'forum.channel_description': 'Description',
  'forum.all_channels': 'All Channels',
  'forum.no_posts': 'No posts yet',
  'forum.no_posts_description': 'Create the first post in the forum',
  'forum.post_type.discussion': 'Discussion',
  'forum.post_type.news': 'News',
  'forum.post_type.announcement': 'Announcement',
  'forum.post_type.deal': 'Deal',
  'forum.post_type.alert': 'Alert',
  'forum.add_image': 'Add image URL',
  'forum.add_video': 'Add video URL',
  'forum.media_url_placeholder': 'Paste image or video URL',
  'forum.trending_topics': 'Trending Topics',
  'forum.search_placeholder': 'Search discussions...',
  'forum.post_success': 'Post created successfully',
  'forum.post_error': 'Failed to create post',
  'forum.channel_success': 'Channel created successfully',
  'forum.channel_error': 'Failed to create channel',
  'nav.leads': 'Leads',
  ...
  'customers.load_error': 'Failed to load customers. Please try again.',
  ...
  'header.search_customer_requests': 'Search customer data...',
  'header.search_unverified_listings': 'Search unverified listings...',
  ...
  'dashboard.active_stages': 'Active stages',
  ...
  'dashboard.revenue_description': 'Monthly revenue analysis for the current year',
  ...
  'leads.load_error': 'Failed to load leads. Please try again.',
  ...
  'contacts.load_error': 'Failed to load contacts. Please try again.',
  'contacts.subtitle': 'Manage your contacts and follow up on their activities',
  'clients.title': 'Clients',
  'clients.subtitle': 'Manage clients and follow up on their activities and details',
  'clients.load_error': 'Failed to load client data. Please try again.',
  'properties.title': 'Property management',
  'properties.load_error': 'Failed to load properties. Please try again.',
  ...
  'pool.search_placeholder': 'Search by city (e.g. Riyadh)...',
  'pool.subtitle': 'Real-time stream of verified customer requests. Sorted by latest first.',
  'pool.table.type': 'Type',
  'pool.table.city': 'City',
  'pool.table.region': 'Region',
  'pool.table.budget': 'Budget (SAR)',
  'pool.table.bedrooms': 'Bedrooms',
  'pool.table.bathrooms': 'Bathrooms',
  'pool.table.living_rooms': 'Living Rooms',
  'pool.table.notes': 'Notes',
  'pool.table.source': 'Source',
  'pool.table.date': 'Date',
  'pool.table.actions': 'Actions',
  'pool.refresh': 'Refresh',
  'pool.filter': 'Filter',
  'pool.all_areas': 'All Areas',
  'pool.no_requests': 'No active requests found.',
  'pool.no_requests_hint': 'Submit a request at /real-estate-requests to see it here.',
  'pool.failed_load': 'Failed to load pool.',
  'pool.login_required': 'Log in as an agent or admin to view the pool.',
  'pool.retry': 'Retry',
  'notifications.load_error': 'Failed to load notifications. Please try again.',
  'pool.send_sms': 'Send SMS',
  'pool.claim': 'Claim',
  'pool.claiming': 'Claiming...',
  'pool.customer_request': 'Customer Request',
  'pool.buyer_pool': 'Buyer Pool',
  'pool.previous': 'Previous',
  'pool.next': 'Next',
  'pool.showing': 'Showing',
  'pool.pagination_of': 'of',
  'pool.sms_title': 'Send SMS to customer',
  'pool.sms_description': 'Your message will be sent via the configured SMS provider.',
  'pool.sms_message': 'Message',
  'pool.sms_placeholder': 'Type your message...',
  'form.save': 'Save',
  'form.cancel': 'Cancel',
  'form.submit': 'Submit',
  'form.close': 'Close',
  ...
  'admin.sidebar.overview.main_dashboard': 'Main Dashboard',
  'admin.sidebar.overview.general_statistics': 'General Statistics',
  ...
  'admin.sidebar.role_management.permissions_management': 'Permissions Management',
  ...
  'admin.sidebar.revenue': 'Revenue & Subscriptions',
  'admin.sidebar.revenue.overview': 'Revenue Overview',
  'admin.sidebar.revenue.active_subscriptions': 'Active Subscriptions',
  'admin.sidebar.revenue.payment_methods': 'Payment Methods',
  'admin.sidebar.revenue.reports': 'Revenue Reports',
  'admin.sidebar.revenue.subscription_plans': 'Subscription Plans',
  'admin.sidebar.complaints': 'Complaints Management',
  'admin.sidebar.complaints.all_complaints': 'All Complaints',
  'admin.sidebar.complaints.open_complaints': 'Open Complaints',
  'admin.sidebar.complaints.resolved_complaints': 'Resolved Complaints',
  'admin.sidebar.complaints.categories': 'Complaint Categories',
  'admin.sidebar.complaints.response_templates': 'Response Templates',
  ...
  'admin.sidebar.features': 'Features & Plans',
  'admin.sidebar.features.feature_comparison': 'Feature Comparison',
  'admin.sidebar.features.pricing_plans': 'Pricing Plans',
  'admin.sidebar.features.corporate_features': 'Corporate Features',
  'admin.sidebar.features.individual_features': 'Individual Features',
  'admin.sidebar.features.feature_requests': 'Feature Requests',
  'admin.sidebar.analytics': 'Advanced Analytics',
  'admin.sidebar.analytics.user_analytics': 'User Analytics',
  'admin.sidebar.analytics.revenue_analytics': 'Revenue Analytics',
  'admin.sidebar.analytics.usage_statistics': 'Usage Statistics',
  'admin.sidebar.analytics.performance_metrics': 'Performance Metrics',
  'admin.sidebar.analytics.custom_reports': 'Custom Reports',
  'admin.sidebar.billing': 'Invoicing & Payments',
  'admin.sidebar.billing.invoices_list': 'Invoices List',
  'admin.sidebar.billing.create_invoice': 'Create Invoice',
  'admin.sidebar.billing.payment_tracking': 'Payment Tracking',
  'admin.sidebar.billing.payment_methods': 'Payment Methods',
  'admin.sidebar.billing.billing_settings': 'Billing Settings',
  'admin.sidebar.security': 'Security',
  'admin.sidebar.security.access_control': 'Access Control',
  'admin.sidebar.security.security_logs': 'Security Logs',
  'admin.sidebar.security.two_factor': 'Two-Factor Authentication',
  'admin.sidebar.security.password_policies': 'Password Policies',
  'admin.sidebar.security.security_alerts': 'Security Alerts',
...
const arabicTranslations: Record<string, string> = {
  ...
  'dashboard.welcome_subtitle': 'نظرة عامة على أداءك اليوم',
  'nav.dashboard': 'لوحة التحكم',
  'nav.pool': 'الطلبات العقارية',
  'nav.forum': 'المنتدى العقاري',
  'forum.title': 'المنتدى العقاري',
  'forum.create_post': 'منشور جديد',
  'forum.start_discussion': 'بدء مناقشة',
  'forum.placeholder': 'ما الذي يدور في ذهنك؟ شارك أخباراً أو إعلانات أو اطرح سؤالاً...',
  'forum.cancel': 'إلغاء',
  'forum.post': 'نشر',
  'forum.posting': 'جاري النشر...',
  'forum.channels': 'القنوات',
  'forum.create_channel': 'إنشاء قناة',
  'forum.channel_name_ar': 'اسم القناة (عربي)',
  'forum.channel_name_en': 'اسم القناة (إنجليزي)',
  'forum.channel_description': 'الوصف',
  'forum.all_channels': 'جميع القنوات',
  'forum.no_posts': 'لا توجد منشورات',
  'forum.no_posts_description': 'أنشئ أول منشور في المنتدى',
  'forum.post_type.discussion': 'مناقشة',
  'forum.post_type.news': 'أخبار',
  'forum.post_type.announcement': 'إعلان',
  'forum.post_type.deal': 'صفقة',
  'forum.post_type.alert': 'تنبيه',
  'forum.add_image': 'إضافة رابط صورة',
  'forum.add_video': 'إضافة رابط فيديو',
  'forum.media_url_placeholder': 'الصق رابط الصورة أو الفيديو',
  'forum.trending_topics': 'المواضيع الشائعة',
  'forum.search_placeholder': 'البحث في المناقشات...',
  'forum.post_success': 'تم إنشاء المنشور بنجاح',
  'forum.post_error': 'فشل إنشاء المنشور',
  'forum.channel_success': 'تم إنشاء القناة بنجاح',
  'forum.channel_error': 'فشل إنشاء القناة',
  ...
  'customers.load_error': 'فشل تحميل العملاء. يرجى المحاولة مرة أخرى.',
  ...
  'nav.marketing_requests': 'ترويج الإعلانات',
  ...
  'sidebar.scheduling': 'الجدولة',
  'sidebar.collaboration': 'التعاون',
  ...
  'dashboard.total_deals': 'إجمالي الصفقات',
  'dashboard.active_stages': 'المراحل النشطة',
  ...
  'dashboard.revenue_description': 'تحليل الإيرادات الشهرية للسنة الحالية',
  ...
  'leads.load_error': 'فشل تحميل العملاء المحتملين. يرجى المحاولة مرة أخرى.',
  ...
  'contacts.load_error': 'فشل تحميل جهات الاتصال. يرجى المحاولة مرة أخرى.',
  'contacts.subtitle': 'إدارة جهات الاتصال ومتابعة أنشطتهم',
  'clients.title': 'العملاء',
  'clients.subtitle': 'إدارة العملاء ومتابعة أنشطتهم وتفاصيلهم',
  'clients.load_error': 'فشل تحميل بيانات العملاء. يرجى المحاولة مرة أخرى.',
  'properties.title': 'إدارة العقارات',
  'properties.load_error': 'فشل تحميل العقارات. يرجى المحاولة مرة أخرى.',
  ...
  'pool.search_placeholder': 'ابحث بالمدينة (مثال: الرياض)...',
  'pool.subtitle': 'طلبات العملاء المؤكدة. مرتبة من الأحدث للأقدم.',
  ...
  'pool.table.notes': 'ملاحظات',
  'pool.table.source': 'المصدر',
  'pool.table.date': 'التاريخ',
  'pool.table.actions': 'الإجراءات',
  'pool.refresh': 'تحديث',
  'pool.filter': 'تصفية',
  'pool.all_areas': 'جميع المناطق',
  'pool.no_requests': 'لا توجد طلبات نشطة.',
  'pool.no_requests_hint': 'قدم طلباً في /real-estate-requests لظهوره هنا.',
  'pool.failed_load': 'فشل تحميل الطلبات.',
  'pool.login_required': 'سجّل الدخول كوكيل أو مدير لعرض الطلبات.',
  'pool.retry': 'إعادة المحاولة',
  'notifications.load_error': 'فشل تحميل الإشعارات. يرجى المحاولة مرة أخرى.',
  'pool.send_sms': 'إرسال رسالة',
  'pool.claim': 'استلام',
  'pool.claiming': 'جاري الاستلام...',
  'pool.customer_request': 'طلب عميل',
  'pool.buyer_pool': 'طلبات المشترين',
  'pool.previous': 'السابق',
  'pool.next': 'التالي',
  'pool.showing': 'عرض',
  'pool.pagination_of': 'من',
  'pool.sms_title': 'إرسال رسالة للعميل',
  'pool.sms_description': 'ستُرسل رسالتك عبر مزود الخدمة المكوّن.',
  'pool.sms_message': 'الرسالة',
  'pool.sms_placeholder': 'اكتب رسالتك...',
  'form.save': 'حفظ',
  'form.cancel': 'إلغاء',
  'form.submit': 'إرسال',
  'form.close': 'إغلاق',
