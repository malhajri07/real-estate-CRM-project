    ...
    return (
      <Card>
        <CardContent className="text-center py-8">
          <p className="text-muted-foreground">يرجى تسجيل الدخول لعرض لوحة التحكم</p>
        </CardContent>
      </Card>
    );
  }
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <Label className="text-sm font-medium text-muted-foreground">المناطق المغطاة</Label>
              ...
              <div>
                <Label className="text-sm font-medium text-muted-foreground">التخصصات</Label>
                <div className="flex flex-wrap gap-1 mt-1">
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <Label className="text-sm font-medium text-muted-foreground">الاسم القانوني</Label>
